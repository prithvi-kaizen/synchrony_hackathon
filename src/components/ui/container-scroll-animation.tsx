...
export const ContainerScroll = ({
  ...
  const rotate = useTransform(scrollYProgress, [0, 1], [15, 0]); // Reduced rotation range
  const scale = useTransform(scrollYProgress, [0, 1], scaleDimensions());
  const translate = useTransform(scrollYProgress, [0, 1], [0, -50]); // Reduced translation range
